...
## Files
- `AudioSupport.yml` — plugin manifest (name, description, version 0.6.0, `interface: js`, `exec: AudioSupportHook.js`, `hooks: Scene.Create.Post`, `tasks: tagAll`, `ui.requires: CommunityScriptsUILibrary`, JS/CSS assets).
